...
CUsb3000BaoFarmInterface::CUsb3000BaoFarmInterface(uint32 uiVid, uint32 uiPid, const char *szDeviceName, const char *szDeviceSerial)
...
bool CUsb3000BaoFarmInterface::OpenDevice(void)
{
    FT_STATUS ftStatus;
    int baudrate = 460800;
...
bool CUsb3000BaoFarmInterface::ResetDevice(void)
{
    return true;
}
